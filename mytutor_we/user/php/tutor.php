...
<body>
    ...
    <div class="w3-margin w3-border w3-center" style="overflow-x:auto;">
        <?php
            ...
            <tr><th style='width:10%'>Tutor Id</th><th style='width:20%'>Tutor Email</th><th style='width:20%'>Tutor Phone</th><th style='width:20%'>Tutor Name</th><th style='width:30%'>Tutor Description</th><th style='width:20%'>Tutor Datereg</th>";
